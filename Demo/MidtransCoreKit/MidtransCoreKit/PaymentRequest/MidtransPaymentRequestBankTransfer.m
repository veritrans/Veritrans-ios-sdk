...
@interface MidtransPaymentRequestBankTransfer ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MidtransPaymentRequestBankTransfer
...
{
    MidtransPaymentRequestBankTransfer *copy = [[MidtransPaymentRequestBankTransfer alloc] init];
