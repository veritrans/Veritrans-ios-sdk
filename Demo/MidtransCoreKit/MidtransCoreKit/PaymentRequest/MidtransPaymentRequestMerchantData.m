...
@interface MidtransPaymentRequestMerchantData ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MidtransPaymentRequestMerchantData
...
{
    MidtransPaymentRequestMerchantData *copy = [[MidtransPaymentRequestMerchantData alloc] init];
