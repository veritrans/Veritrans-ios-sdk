...
@interface MidtransPaymentRequestPaymentOptions ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MidtransPaymentRequestPaymentOptions
...
{
    MidtransPaymentRequestPaymentOptions *copy = [[MidtransPaymentRequestPaymentOptions alloc] init];
