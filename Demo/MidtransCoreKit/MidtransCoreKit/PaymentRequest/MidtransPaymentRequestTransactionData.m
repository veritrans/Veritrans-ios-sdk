...
@interface MidtransPaymentRequestTransactionData ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MidtransPaymentRequestTransactionData
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        if ([receivedPaymentRequestItemDetails isKindOfClass:[NSArray class]]) {
            for (NSDictionary *item in (NSArray *)receivedPaymentRequestItemDetails) {
                if ([item isKindOfClass:[NSDictionary class]]) {
                    [parsedPaymentRequestItemDetails addObject:[MidtransPaymentRequestItemDetails modelObjectWithDictionary:item]];
                }
            }
        } else if ([receivedPaymentRequestItemDetails isKindOfClass:[NSDictionary class]]) {
            [parsedPaymentRequestItemDetails addObject:[MidtransPaymentRequestItemDetails modelObjectWithDictionary:(NSDictionary *)receivedPaymentRequestItemDetails]];
        }
        
        self.itemDetails = [NSArray arrayWithArray:parsedPaymentRequestItemDetails];
        self.customerDetails = [MidtransPaymentRequestCustomerDetails modelObjectWithDictionary:[dict objectForKey:kPaymentRequestTransactionDataCustomerDetails]];
        self.transactionDataIdentifier = [self objectOrNilForKey:kPaymentRequestTransactionDataId fromDictionary:dict];
        self.transactionDetails = [MidtransPaymentRequestTransactionDetails modelObjectWithDictionary:[dict objectForKey:kPaymentRequestTransactionDataTransactionDetails]];
        self.paymentOptions = [MidtransPaymentRequestPaymentOptions modelObjectWithDictionary:[dict objectForKey:kPaymentRequestTransactionDataPaymentOptions]];
        ...
        self.bankTransfer = [MidtransPaymentRequestBankTransfer modelObjectWithDictionary:[dict objectForKey:kPaymentRequestTransactionDataBankTransfer]];
...
{
    MidtransPaymentRequestTransactionData *copy = [[MidtransPaymentRequestTransactionData alloc] init];
