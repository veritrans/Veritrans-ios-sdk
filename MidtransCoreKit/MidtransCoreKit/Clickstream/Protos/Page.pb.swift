...
public class Midtrans_Clickstream_Products_Events_Ui_Page {
  ...
  public var eventTimestamp:  Google_Protobuf_Timestamp {
    get {return _storage._eventTimestamp ??  Google_Protobuf_Timestamp()}
    set {_uniqueStorage()._eventTimestamp = newValue}
  }

  public var deviceTimestamp:  Google_Protobuf_Timestamp {
    get {return _storage._deviceTimestamp ??  Google_Protobuf_Timestamp()}
...
extension Midtrans_Clickstream_Products_Events_Ui_Page:  Message,  _MessageImplementationBase,  _ProtoNameProviding {
  ...
  public class _StorageClass {
    ...
    var _eventTimestamp:  Google_Protobuf_Timestamp? = nil
    var _deviceTimestamp:  Google_Protobuf_Timestamp? = nil
  ...
  public func decodeMessage<D:  Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 7: try { try decoder.decodeMapField(fieldType:  _ProtobufMap< ProtobufString, ProtobufString>.self, value: &_storage._properties) }()
  ...
  public func traverse<V:  Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._properties.isEmpty {
        try visitor.visitMapField(fieldType:  _ProtobufMap< ProtobufString, ProtobufString>.self, value: _storage._properties, fieldNumber: 7)
      }
