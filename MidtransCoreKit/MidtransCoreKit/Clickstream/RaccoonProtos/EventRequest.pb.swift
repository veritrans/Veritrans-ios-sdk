...
struct Odpf_Raccoon_EventRequest {
  ...
  var sentTime: Google_Protobuf_Timestamp {
    get {return _sentTime ?? Google_Protobuf_Timestamp()}
  ...
  fileprivate var _sentTime: Google_Protobuf_Timestamp? = nil
}
...
extension Odpf_Raccoon_EventRequest: Message, _MessageImplementationBase, _ProtoNameProviding {
