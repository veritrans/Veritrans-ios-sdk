...
extension Odpf_Raccoon_Status: _ProtoNameProviding {
...
extension Odpf_Raccoon_Code: _ProtoNameProviding {
  static let _protobuf_nameMap: _NameMap = [
...
extension Odpf_Raccoon_EventResponse: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try decoder.decodeMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufString>.self, value: &self.data)
      default: break
      }
    }
  }
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    ...
    if !self.data.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufString>.self, value: self.data, fieldNumber: 5)
    }
