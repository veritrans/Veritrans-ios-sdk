 ...
 */
typedef NS_ENUM(NSUInteger, MTCreditCardPaymentFeature) {
    /**
     ...
     */
    MTCreditCardPaymentFeatureOneClick,
     ...
     */
    MTCreditCardPaymentFeatureTwoClick,
     ...
     */
    MTCreditCardPaymentFeatureNormal,
    
    /**
     Unknown credit card payment type. Internal usage only.
     */
    MTCreditCardPaymentFeatureUnknown
};
