...
- (void)closePressed:(id)sender {
    NSError *error = [[NSError alloc] initWithDomain:VT_ERROR_DOMAIN code:VT_ERROR_CODE_3DSECURE userInfo:@{NSLocalizedDescriptionKey:@"3D Secure transaction canceled by user"}];
