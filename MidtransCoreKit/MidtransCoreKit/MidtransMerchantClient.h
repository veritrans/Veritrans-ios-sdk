...
/**
 ...
 credit card information is modeled using `MidtransMaskedCreditCard`. This `MidtransMaskedCreditCard` instance can be fetched using method `registerCreditCard:completion` in `VTClient`.
 */
