...
+ (instancetype)modelObjectWithDictionary:(NSDictionary *)dict transactionDetails:(MidtransItemDetail *)transactionDetails customerDetails:(MidtransCustomerDetails *)customerDetails itemDetails:(NSArray <MidtransItemDetail*>*)itemDetails;
