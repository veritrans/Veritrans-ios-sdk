...
@interface MTPaymentRequestCustomerDetails ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MTPaymentRequestCustomerDetails
...
{
    MTPaymentRequestCustomerDetails *copy = [[MTPaymentRequestCustomerDetails alloc] init];
