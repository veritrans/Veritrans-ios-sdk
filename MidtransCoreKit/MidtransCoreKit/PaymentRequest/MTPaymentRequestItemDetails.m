...
@interface MTPaymentRequestItemDetails ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MTPaymentRequestItemDetails
...
{
    MTPaymentRequestItemDetails *copy = [[MTPaymentRequestItemDetails alloc] init];
