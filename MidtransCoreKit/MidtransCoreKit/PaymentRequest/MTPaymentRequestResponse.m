...
#import "MTPaymentRequestResponse.h"
...
@interface MTPaymentRequestResponse ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MTPaymentRequestResponse
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            self.transactionData = [MTPaymentRequestTransactionData modelObjectWithDictionary:[dict objectForKey:kPaymentRequestResponseTransactionData]];
            self.merchantData = [MTPaymentRequestMerchantData modelObjectWithDictionary:[dict objectForKey:kPaymentRequestResponseMerchantData]];
...
{
    MTPaymentRequestResponse *copy = [[MTPaymentRequestResponse alloc] init];
