...
@interface MTPaymentRequestTransactionDetails ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MTPaymentRequestTransactionDetails
...
{
    MTPaymentRequestTransactionDetails *copy = [[MTPaymentRequestTransactionDetails alloc] init];
