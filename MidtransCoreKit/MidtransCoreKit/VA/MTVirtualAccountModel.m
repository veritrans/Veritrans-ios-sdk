...
#import "MTVirtualAccountModel.h"
...
@interface MTVirtualAccountModel ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MTVirtualAccountModel
...
{
    MTVirtualAccountModel *copy = [[MTVirtualAccountModel alloc] init];
