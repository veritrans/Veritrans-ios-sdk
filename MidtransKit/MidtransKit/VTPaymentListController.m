...
- (void)viewDidLoad {
    ...
    [[VTMerchantClient sharedClient] requestPaymentlistWithToken:self.token.tokenId completion:^(PaymentRequestResponse * _Nullable response, NSError * _Nullable error) {
        [self hideLoadingHud];
