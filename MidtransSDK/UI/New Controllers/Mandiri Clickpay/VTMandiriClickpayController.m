...
- (void)viewDidLoad {
    ...
    NSNumber *grossAmount = self.info.transaction.grossAmount;
    ...
    self.input2Label.text = [MidtransMandiriClickpayHelper generateInput2FromGrossAmount:grossAmount];
    self.input3Label.text = [MidtransMandiriClickpayHelper generateInput3];
    self.orderIdLabel.text = self.info.transaction.orderID;
    self.amountLabel.text = grossAmount.formattedCurrencyNumber;
...
- (IBAction)confirmPaymentPressed:(UIButton *)sender {
    ...
    NSString *_cardNumber = [self.debitNumberTextField.text stringByReplacingOccurrencesOfString:@" " withString:@""];
