...
@interface MidtransPaymentRequestTransactionDetails ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MidtransPaymentRequestTransactionDetails
...
{
    MidtransPaymentRequestTransactionDetails *copy = [[MidtransPaymentRequestTransactionDetails alloc] init];
